function Home() {
  return ( 
  <div>
    <h1>Projeto Caminho Suave</h1>

    <div>
      <p>
        Esse projeto foi inspirado para ajudar minha imrãzinha nos estudos!
      </p>
      <p>
        O Projeto consiste em criar um site onde eu/usuario possa adicionar cards de pergunta com a respctiva resposta para validar determinado conhecimento.
        <br />
